		...
		<div id="container">
			...
			<header class="header" role="banner" itemscope itemtype="http://schema.org/WPHeader">
				...
				<div id="inner-header" class="wrap cf">
					...
					<p id="logo" class="h1" itemscope itemtype="http://schema.org/Organization"><a href="<?php echo home_url(); ?>"  title="<?php htmlspecialchars( bloginfo('name') . ':' . bloginfo('description') ) ?> "rel="nofollow"><?php bloginfo('name'); ?></a></p>
